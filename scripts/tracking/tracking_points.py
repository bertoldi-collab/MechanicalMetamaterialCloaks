import cv2
import numpy as np
from scripts.tracking.utils import find_markers, search_window_size_default, marker_template_size_default, upscaling_factor_default, step_size_default
import argparse
...
def track_points(
    ...
    Args:
        ...
        step_size (int, optional): Step size for tracking. Defaults to 1.
